...
const MembersByGroupChart = dynamic(() => import('./MembersByGroupChart'), {
  ssr: false,
  loading: () => <div className="h-[260px] flex items-center justify-center text-muted-foreground text-sm">Loading chart...</div>,
})
